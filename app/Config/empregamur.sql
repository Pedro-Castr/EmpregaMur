...
CREATE TABLE vaga (
  ...
  modalidade INT NOT NULL COMMENT '1 - Presencial, 2 - Semipresencial, 3 - Remoto',
  vinculo INT NOT NULL COMMENT '1 - CLT, 2 - PJ, 3 - Estágio',
  dtInicio DATE NOT NULL,
  dtFim DATE NOT NULL,
  estabelecimento_id INT NOT NULL,
  statusVaga INT NOT NULL COMMENT '1 - Pendente, 2 - Ativa, 3 - Fechada',
  PRIMARY KEY (vaga_id),
  INDEX idx_cargo (cargo_id),
  INDEX idx_estabelecimento (estabelecimento_id),
  FOREIGN KEY (cargo_id) REFERENCES cargo (cargo_id),
